...
sudo docker run -it -p 8000:8080 --mount type=bind,source=~/pypline/in/,target=/root/airflow/dags/ --mount type=bind,source=~/pypline/out/,target=/root/airflow/output airflow bash
...
sudo docker run -it --net=host --expose 5001 -p 5050:5001 --mount type=bind,source=/home/nick/drive/school/cs476/pypline/in/,target=/root/airflow/dags/ flaskui bash
